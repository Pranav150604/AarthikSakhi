...
export default function Home() {
      ...
      if (isFreshLogin) {
        ...
        const fetchChatHistory = async () => {
          try {
            ...
            // Silently handle the error by logging or skipping
            console.error('Failed to fetch chat history:', error); // Optional: You can remove this line too
          }
        };
  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    if (newMessage.trim()) {
      ...
      // Inbuilt question and answer logic
      const predefinedAnswers: { [key: string]: string } = {
        "Let's discuss Investment Planning": "Investment planning is a powerful tool for women empowerment, enabling financial independence and fostering long-term security. Women often face unique financial challenges, such as longer life expectancies, gender pay gaps, and career breaks due to caregiving responsibilities. Strategic investment planning can help bridge these gaps by building wealth over time and providing a safety net for unforeseen circumstances. By investing in diversified portfolios that include stocks, bonds, mutual funds, or real estate, women can achieve financial goals like education, entrepreneurship, or retirement with greater confidence. Moreover, early financial literacy programs targeting women can empower them to make informed decisions, breaking traditional stereotypes that limit their participation in financial markets.",
        "How can I save money?": "To save money, track your expenses, create a budget, and set realistic financial goals. Would you like a personalized plan?",
        "What is AarthikSakhi?": "AarthikSakhi is your personal financial assistant designed to help you manage and plan your finances effectively.",
      };
  
      // Check if the user's message matches any predefined question
      if (predefinedAnswers[userMessage.content.trim()]) {
        const assistantResponse = predefinedAnswers[userMessage.content.trim()];
        ...
        {localMessages.length === 0 ? (
          <Flex direction="column" align="center" justify="center" h="100%" py={8}>
            <VStack spacing={6} mb={8}>
              <Heading size="lg"  mt={15} textAlign="center">Welcome to AarthikSakhi</Heading>
              <TypewriterText
                text="I am your Digital Twin. How can I help you today?"
                fontSize="xl"
                fontWeight="medium"
                textAlign="center"
              />
